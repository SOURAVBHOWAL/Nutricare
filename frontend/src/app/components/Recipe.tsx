...
export default function RecipeGenerator() {
  ...
  const [agree, setAgree] = useState(true); // Checkbox state
  ...
  return (
    <>
    <NavBar/>
<div className="min-h-screen bg-gradient-to-br from-pink-200 to-blue-400 p-6 flex flex-col items-center font-sans ">
<motion.div
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="w-full max-w-2xl bg-white p-8 rounded-3xl shadow-2xl border border-gray-200 mt-30"      >
<h1 className="text-4xl font-extrabold text-center mb-8 text-gray-800">🍏 Automated Diet Planner
        </h1>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={handleSubmit}
          className="w-full bg-blue-500 text-white p-3 rounded-xl font-semibold shadow-md hover:bg-green-600 transition-all"        >
